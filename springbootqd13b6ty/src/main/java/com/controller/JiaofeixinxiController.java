...
public class JiaofeixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiaofeixinxiEntity jiaofeixinxi,
                @RequestParam(required = false) Double shuifeistart,
                @RequestParam(required = false) Double shuifeiend,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			jiaofeixinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<JiaofeixinxiEntity> ew = new EntityWrapper<JiaofeixinxiEntity>();
                if(shuifeistart!=null) ew.ge("shuifei", shuifeistart);
                if(shuifeiend!=null) ew.le("shuifei", shuifeiend);
